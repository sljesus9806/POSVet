...
> Ejecutado: 2026-06-08T04:24:34.772Z
...
| CFG-04 | crearUbicacion Sucursal Centro (SUCURSAL) creada y activa | ✅ | cmq4piiwv0002worqszzx4wie |
...
| USR-02 | crear un usuario de cada rol (CAJERO/ALMACENISTA/SUPERVISOR/READONLY) | ✅ | CAJERO creado (cmq4pij4l0007worqif1c9n7v) |
| USR-02 | crear un usuario de cada rol (CAJERO/ALMACENISTA/SUPERVISOR/READONLY) | ✅ | ALMACENISTA creado (cmq4pijba000aworq7vw7g6y2) |
| USR-02 | crear un usuario de cada rol (CAJERO/ALMACENISTA/SUPERVISOR/READONLY) | ✅ | SUPERVISOR creado (cmq4pijhu000dworqt55m34h3) |
| USR-02 | crear un usuario de cada rol (CAJERO/ALMACENISTA/SUPERVISOR/READONLY) | ✅ | READONLY creado (cmq4pijor000gworq60oh9qhq) |
...
| USR-07 | 5 intentos fallidos → bloqueo 15 min (UsuarioBloqueadoError con pass correcta) | ✅ | bloqueadoHasta=2026-06-08T04:39:33.689Z |
...
| REP-09 | generarReportePDF produce un buffer válido para cada reporte | ✅ | 8 PDFs generados (ventas-dia:5999B, productos-vendidos:7386B, ventas-por-usuario:4954B, inventario-actual:14915B, por-caducar:5432B, antiguedad-cxc:4949B, antiguedad-cxp:4963B, sin-movimiento:6776B) |
