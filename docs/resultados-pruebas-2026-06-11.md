...
> Ejecutado: 2026-06-11T03:35:54.365Z
...
| CFG-04 | crearUbicacion Sucursal Centro (SUCURSAL) creada y activa | ✅ | cmq8y3hg00002wopqz09mu3oh |
...
| USR-02 | crear un usuario de cada rol (CAJERO/ALMACENISTA/SUPERVISOR/READONLY) | ✅ | CAJERO creado (cmq8y3hmy0007wopqpmcs9y7u) |
| USR-02 | crear un usuario de cada rol (CAJERO/ALMACENISTA/SUPERVISOR/READONLY) | ✅ | ALMACENISTA creado (cmq8y3htk000awopqp4i3kunl) |
| USR-02 | crear un usuario de cada rol (CAJERO/ALMACENISTA/SUPERVISOR/READONLY) | ✅ | SUPERVISOR creado (cmq8y3i0f000dwopqa586zki5) |
| USR-02 | crear un usuario de cada rol (CAJERO/ALMACENISTA/SUPERVISOR/READONLY) | ✅ | READONLY creado (cmq8y3i79000gwopqh3n5gk4s) |
...
| USR-07 | 5 intentos fallidos → bloqueo 15 min (UsuarioBloqueadoError con pass correcta) | ✅ | bloqueadoHasta=2026-06-11T03:50:53.170Z |
