...
const NAV: Array<NavItem & { permiso?: string }> = [
  ...
  { href: "/productos", label: "Productos e inventario", iconName: "productos", permiso: "productos:leer" },
  ...
  { href: "/facturacion", label: "Facturación", iconName: "facturacion", permiso: "facturacion:leer" },
